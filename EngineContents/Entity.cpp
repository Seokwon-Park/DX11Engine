...
{
	return UEnginePhysics::RayCast(GetLevel(), GetActorLocation() + FVector4(12.0f, 0.0f, 0.0f), FVector4::DOWN, 29.0f, ECollisionLayer::Ground) || UEnginePhysics::RayCast(GetLevel(), GetActorLocation() + FVector4(-12.0f, 0.0f, 0.0f), FVector4::DOWN, 29.0f, ECollisionLayer::Ground);
}
